...
| **[🛒Supermarket product analysis and recommender system](https://github.com/MarinaGRey/Product_recommender)**       | *In this project we made a huge project that consisted on scrapping 11 supermarkets, using an API, make a huge preprocessing, cluster and analyze the results, create meaningful graphs, generate a content-based recommender system and finally generate an interactive dash using Gradio.*    | 
